...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButtonImport = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButtonImport.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButtonImport.setStyleSheet("color: rgb(52, 101, 164);")
        self.pushButtonImport.setFlat(True)
        self.pushButtonImport.setObjectName("pushButtonImport")
        self.verticalLayout_2.addWidget(self.pushButtonImport)
        self.pushButtonInventaire = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButtonInventaire.setStyleSheet("color: rgb(52, 101, 164);")
        self.pushButtonInventaire.setFlat(True)
        self.pushButtonInventaire.setObjectName("pushButtonInventaire")
        self.verticalLayout_2.addWidget(self.pushButtonInventaire)
        ...
        self.pushButtonHistory = QtWidgets.QPushButton(self.groupBox)
        self.pushButtonHistory.setStyleSheet("color: rgb(52, 101, 164);")
        self.pushButtonHistory.setFlat(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonImport.setText(_translate("MainWindow", "Importer les articles"))
        self.pushButtonInventaire.setText(_translate("MainWindow", "Faire un inventaire"))
        ...
        self.show_command.setText(_translate("MainWindow", "Gérer les commandes"))
        self.show_command_article.setText(_translate("MainWindow", "Afficher les articles commandés"))
        self.pushButtonHistory.setText(_translate("MainWindow", "Rapport des receptions"))
        ...
        self.selling_history.setText(_translate("MainWindow", "Gérer les ventes"))
