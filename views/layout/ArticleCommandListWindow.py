...
class Ui_ArticleCommandListWidget(object):
    def setupUi(self, ArticleCommandListWidget):
        ...
        self.label_2 = QtWidgets.QLabel(ArticleCommandListWidget)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout.addWidget(self.label_2)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.pushButton = QtWidgets.QPushButton(ArticleCommandListWidget)
    ...
    def retranslateUi(self, ArticleCommandListWidget):
        ...
        self.label_2.setText(_translate("ArticleCommandListWidget", "0"))
        self.pushButton.setText(_translate("ArticleCommandListWidget", "Quitter"))
